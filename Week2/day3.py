...
# access
print(my_dict["a"])               #in dictionaries you don't have an order of entry!!! You can only access it by name/keys
...
# # delete item     # we need to be careful because when deleting the key, we also delete the value
# print(len(my_dict))
# del(my_dict["a"])
# print(my_dict)
# print(len(my_dict))
...
# class Student():
#     def __init__(self, firstname, lastname, email, country_code, phone_number, github, country, discord_id, fav_food, dream):     #self é apenas uma convenção humana, é o nome que se dá ao objeto! Podia ser qualquer outro nome!!
...
'''
my_print() is called a method because it sits on a object.
print() is called a function because it sits on its own.
'''


#use a list if you want to limit the social groups people can enter in the Students class (Homework)
